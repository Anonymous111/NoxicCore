...
#define BARK_SETUP_CARNIES_4 "That's right friend! The Darkmoon Faire is going be right here. Just as soon as I unload those huge wagons, put all the tents, erect the zoo and pour the drinks. Make sure you come back!"
