...
class UlduarTeleporterAI : public GameObjectAIScript
{
	public:
		...
		void OnActivate(Player* player)
		{
			...
			menu->AddItem(Arcpro::Gossip::ICON_CHAT, "Expedition Base Camp.", 0);
			menu->AddItem(Arcpro::Gossip::ICON_CHAT, "Formation Grounds", 1);
			menu->AddItem(Arcpro::Gossip::ICON_CHAT, "Colossal Forge", 2);
			menu->AddItem(Arcpro::Gossip::ICON_CHAT, "Scrapyard", 3);
			menu->AddItem(Arcpro::Gossip::ICON_CHAT, "Antechamber of Ulduar", 4);
			menu->AddItem(Arcpro::Gossip::ICON_CHAT, "Shattered Walkway", 5);
			menu->AddItem(Arcpro::Gossip::ICON_CHAT, "Conservatory of Life", 6);
			menu->AddItem(Arcpro::Gossip::ICON_CHAT, "Spark of Imagination", 7);
			menu->AddItem(Arcpro::Gossip::ICON_CHAT, "Prison of Yogg-Saron", 8);
