...
void CommandTableStorage::Init()
{
	...
	static ChatCommand commandTable[] =
	{
		...
		{ "die",				'r', &ChatHandler::HandleKillByPlrCommand,						".die <name> - Kills specified player",																										NULL,						0,						0, 0 },
		...
		{ "gmannounce",			'u', &ChatHandler::HandleGMAnnounceCommand,						"Sends message to all online GMs",																											NULL,						0,						0, 0 },
